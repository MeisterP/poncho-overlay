...
epatch "${FILESDIR}"/0001-windowManager-Fix-fullscreen-animations-on-dualscree.patch
epatch "${FILESDIR}"/0002-Fix-some-issues-reported-by-Bj-rn-Lie-in-bug-740906.patch
epatch "${FILESDIR}"/0003-windowManager-fix-fullscreen-clone-being-left-around.patch
epatch "${FILESDIR}"/0004-Add-RLM-as-appropriate.patch
epatch "${FILESDIR}"/0005-windowMenu-Ensure-the-source-actor-isn-t-sized-0x0.patch
epatch "${FILESDIR}"/0006-Fix-text-scaling-factor-under-wayland.patch
epatch "${FILESDIR}"/0007-Updated-Icelandic-translation.patch
epatch "${FILESDIR}"/0008-Updated-Hungarian-translation.patch
epatch "${FILESDIR}"/0009-gdm-don-t-emit-start-session-when-ready-from-idle-fu.patch
epatch "${FILESDIR}"/0010-animation-Run-every-16ms-not-ever-14ms.patch
epatch "${FILESDIR}"/0011-animation-do-spinner-animation-with-low-priority.patch
