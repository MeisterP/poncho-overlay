...
SRC_URI="http://git.fedorahosted.org/cgit/lvm2.git/snapshot/${PN}-${PV//./_}.tar.gz"
...
src_prepare() {
	...
	epatch "${FILESDIR}"/{01,02}-hotfix.patch
...
src_install() {
	...
	dodoc README VERSION* WHATS_NEW WHATS_NEW_DM doc/*.{c,txt}
	dodoc -r doc/kernel
